...
export class MonitoringSmdServices {
  ...
  static async monitoringSmdList(
    ...
    payload.fieldResolverMap['doSmdDateTime'] = 'ds.do_smd_time';
    ...
    q.selectRaw(
      ['ds.do_smd_time', 'doSmdDateTime'],
      ['ds.do_smd_code', 'doSmdCode'],
      ['ds.trip', 'trip'],
      ['ds.branch_to_name_list', 'doSmdBranchNameList'],
      ['b.branch_name', 'branchFromName'],
    ...
    q.innerJoin(e => e.doSmdDetails, 'dsd', j =>
