...
@Entity('do_smd_status', { schema: 'public' })
...
export class DoSmdStatus extends TmsBaseEntity {
  ...
  @Column('character varying', {
    nullable: false,
    length: 255,
    name: 'do_smd_status_name',
  })
  doSmdStatusName: string;

  @Column('character varying', {
    nullable: false,
    length: 255,
    name: 'do_smd_status_title',
  })
  doSmdStatusTitle: string;

  @Column('character varying', {
    nullable: false,
    length: 255,
    name: 'do_smd_status_desc',
  })
  doSmdStatusDesc: string;
