...
export class District {
    ...
    @OneToMany(type=>PackagePrice, package_price=>package_price.districtIdFrom)
    ...
    @OneToMany(type=>PackagePriceSpecial, package_price_special=>package_price_special.districtIdFrom)
    packagePriceSpecials:PackagePriceSpecial[];
    

   
    @OneToMany(type=>PackagePriceSpecial, package_price_special=>package_price_special.districtIdTo)
