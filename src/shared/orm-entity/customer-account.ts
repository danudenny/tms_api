...
@Index("customer_account_customer_account_code_key",["customerAccountCode",],{unique:true})
...
export class CustomerAccount {
    ...
    @OneToMany(type=>PackagePriceSpecial, package_price_special=>package_price_special.customerAccount)
