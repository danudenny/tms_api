...
@Entity('do_pod_return_detail', {schema: 'public'})
export class DoPodReturnDetail extends TmsBaseEntity {
...
@PrimaryGeneratedColumn('uuid', {
  ...
  @ManyToOne(() => DoPodReturn)
  @JoinColumn({ name: 'do_pod_return_id' })
  doPodReturn: DoPodReturn;
