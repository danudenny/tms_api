...
@Index("package_price_unique_key9",["cityIdFrom","countryIdTo","packageType",],{unique:true})
@Index("package_price_unique_key10",["cityIdFrom","packageType","provinceIdTo",],{unique:true})
@Index("package_price_unique_key11",["cityIdFrom","cityIdTo","packageType",],{unique:true})
@Index("package_price_unique_key12",["cityIdFrom","districtIdTo","packageType",],{unique:true})
@Index("package_price_unique_key7",["cityIdTo","packageType","provinceIdFrom",],{unique:true})
@Index("package_price_unique_key3",["cityIdTo","countryIdFrom","packageType",],{unique:true})
@Index("package_price_unique_key15",["cityIdTo","districtIdFrom","packageType",],{unique:true})
@Index("package_price_unique_key2",["countryIdFrom","packageType","provinceIdTo",],{unique:true})
@Index("package_price_unique_key4",["countryIdFrom","districtIdTo","packageType",],{unique:true})
@Index("package_price_unique_key1",["countryIdFrom","countryIdTo","packageType",],{unique:true})
@Index("package_price_unique_key5",["countryIdTo","packageType","provinceIdFrom",],{unique:true})
@Index("package_price_unique_key13",["countryIdTo","districtIdFrom","packageType",],{unique:true})
@Index("package_price_unique_key16",["districtIdFrom","districtIdTo","packageType",],{unique:true})
@Index("package_price_unique_key14",["districtIdFrom","packageType","provinceIdTo",],{unique:true})
@Index("package_price_unique_key8",["districtIdTo","packageType","provinceIdFrom",],{unique:true})
...
@Index("package_price_unique_key6",["packageType","provinceIdFrom","provinceIdTo",],{unique:true})
...
export class PackagePrice {
    ...
    @ManyToOne(type=>PackageType, package_type=>package_type.packagePrices,{  nullable:false, })
