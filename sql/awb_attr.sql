...
-- Table: public.awb_attr 11/07/2019
CREATE TABLE public.awb_attr
(
    awb_attr_id bigint NOT NULL DEFAULT nextval('awb_attr_awb_attr_id_seq'::regclass),
    awb_id bigint,
    ...
    CONSTRAINT awb_attr_id_pkey PRIMARY KEY (awb_attr_id)
)
WITH (
    OIDS=FALSE
);