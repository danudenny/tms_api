...
CREATE TABLE "public"."attachment_tms" (
  ...
  "attachment_name" varchar(255) COLLATE "pg_catalog"."default",
  "filename" varchar(255) COLLATE "pg_catalog"."default",
  "file_mime" varchar(255) COLLATE "pg_catalog"."default",
  "file_provider" varchar(255) COLLATE "pg_catalog"."default",
  "s3_bucket_name" varchar(255) COLLATE "pg_catalog"."default",
